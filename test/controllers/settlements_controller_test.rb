...
class SettlementsControllerTest < ActionController::TestCase
  ...
  test "should create settlement" do
    assert_difference('Settlement.count') do
      post :create, settlement: { ancestry: @settlement.ancestry, color: @settlement.color, icon: @settlement.icon, language_id: @settlement.language_id, name: @settlement.name }
    end
  ...
  test "should update settlement" do
    patch :update, id: @settlement, settlement: { ancestry: @settlement.ancestry, color: @settlement.color, icon: @settlement.icon, language_id: @settlement.language_id, name: @settlement.name }
    assert_redirected_to settlement_path(assigns(:settlement))
  end
